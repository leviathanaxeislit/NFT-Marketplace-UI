      ...
      <div className="header-slider">
       ...
       <Slider {...settings} className='slider'>
            <div className='slider-card'>
              ...
              <p className='slider-card-price'>5.250 <span>WINR</span></p>
            </div>
            <div className='slider-card'>
              ...
              <p className='slider-card-price'>4.932 <span>WINR</span></p>
            </div>
            <div className='slider-card'>
              ...
              <p className='slider-card-price'>4.620 <span>WINR</span></p>
            </div>
            <div className='slider-card'>
              ...
              <p className='slider-card-price'>4.125 <span>WINR</span></p>
            </div>
            <div className='slider-card'>
              ...
              <p className='slider-card-price'>3.921 <span>WINR</span></p>
            </div>
            <div className='slider-card'>
              ...
              <p className='slider-card-price'>3.548 <span>WINR</span></p>
            </div>
        </Slider>
      </div>
    </div>
